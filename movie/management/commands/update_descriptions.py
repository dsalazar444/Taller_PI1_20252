...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Se pone esta ubicación porque cuando lo ejecutamos, lo hacemos desde la raiz,
        # entonces este archivo estará en la misma carpeta que nosotros, por eso el ./
        ...
        for movie in movies:
            ...
            try:
                ...
                self.stderr.write(f"Failed for {movie.title}: {str(e)}") #Imprime mensaje de error desde comando
